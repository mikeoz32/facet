...
Facet matches Crystal's exact expansion text for **755/900 (83.89%)** portable
...
| --- | ---: | --- |
| Direct, source-replayable calls | 900 | 755 exact; 145 explicit mismatches |
...
755/900 nor 371/371 is a claim of complete Crystal macro compatibility. The 145
...
1. Extend the captured AST value model from the completed location,
   ...
   declaration, and type-syntax slices to other expression families. Type
