...
Facet matches Crystal's exact expansion text for **506/900 (56.22%)** portable
...
| --- | ---: | --- |
| Direct, source-replayable calls | 900 | 506 exact; 394 explicit mismatches |
...
506/900 nor 371/371 is a claim of complete Crystal macro compatibility. The 394
...
1. Preserve location, documentation, and other non-source AST metadata in the
   runtime fixture and Facet macro value model.
