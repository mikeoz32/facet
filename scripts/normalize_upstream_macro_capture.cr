...
header = RuntimeMacroFixtureHeader.new(
  ...
  structured_declaration_argument_count: cases.sum do |fixture_case|
    fixture_case.arguments.count do |argument|
      argument.structure.try do |node|
  ...
  structured_asm_argument_count: cases.sum do |fixture_case|
    fixture_case.arguments.count do |argument|
      argument.structure.try do |node|
  ...
  structured_expression_argument_count: cases.sum do |fixture_case|
    fixture_case.arguments.count do |argument|
      argument.structure.try do |node|
  ...
  structured_misc_argument_count: cases.sum do |fixture_case|
    fixture_case.arguments.count do |argument|
      argument.structure.try do |node|
        {"Crystal::UninitializedVar", "Crystal::MacroExpression", "Crystal::MacroIf",
         "Crystal::MacroFor", "Crystal::MacroLiteral", "Crystal::MacroVar", "Crystal::Not",
         "Crystal::PointerOf", "Crystal::SizeOf", "Crystal::InstanceSizeOf", "Crystal::AlignOf",
  ...
  structured_value_argument_count: cases.sum do |fixture_case|
    fixture_case.arguments.count do |argument|
      argument.structure.try do |node|
        {"Crystal::Annotation", "Crystal::StringInterpolation", "Crystal::ReadInstanceVar",
         "Crystal::TypeDef", "Crystal::ExternalVar", "Crystal::When"}.includes?(node.kind)
      end || false
    end
  end,
)
