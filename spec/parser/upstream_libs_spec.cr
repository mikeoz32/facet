...
describe "Parser upstream parity (libs)" do
  ...
  it_parses "lib LibC; fun foo : Int**; end"
  it_parses "lib LibC; fun foo(a : ::B, ::C -> ::D); end"
  ...
  it_parses "lib LibC; struct Foo; x : Int**; end end"
  it_parses "lib LibC; struct Foo; x, y, z : Int; end end"
  ...
  it_parses "lib LibC; {{ 1 }}; end"
  it_parses "lib LibC; {% if 1 %}2{% end %}; end"
  it_parses "lib LibC; struct Foo; {{ 1 }}; end; end"
  it_parses "lib LibC; struct Foo; {% if 1 %}2{% end %}; end; end"
  it_parses "lib LibC\n@[Bar]; end"
end
